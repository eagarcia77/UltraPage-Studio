  ...
  const copyHtml = async () => {
    ...
    try {
      if (navigator.clipboard.write && typeof ClipboardItem !== "undefined") {
        ...
        toast.success("Contenido listo para Blackboard Ultra", { description: "Puede pegarlo en el editor visual o en el editor HTML <>; Blackboard utilizará el formato correspondiente." });
      } else {
        await navigator.clipboard.writeText(blackboardMarkup);
        toast.success("Código HTML compatible copiado", { description: "Péguelo en el editor HTML <> de Blackboard Ultra." });
      }
    } catch {
      try {
        await navigator.clipboard.writeText(blackboardMarkup);
        toast.success("Código HTML compatible copiado", { description: "El navegador utilizó el modo compatible. Péguelo en el editor HTML <> de Blackboard Ultra." });
      } catch {
        toast.error("No se pudo acceder al portapapeles", { description: "Abra la pestaña HTML y copie el código manualmente." });
      }
    }
  };
