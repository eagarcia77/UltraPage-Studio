...
export default function Home() {
  ...
  const [activeFormats, setActiveFormats] = useState({ bold: false, italic: false, underline: false, strikeThrough: false, subscript: false, superscript: false, unorderedList: false, orderedList: false });
  ...
  const executeRibbonCommand = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const actions: Record<string, () => void> = {
      ...
      "table of contents": generateTableOfContents, "clear formatting": clearFormatting,
    };
